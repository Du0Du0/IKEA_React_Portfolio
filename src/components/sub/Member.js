			...
			<div className='container'>
					...
					<div className='col-2 flex '>
						<div className='tile'>
							...
							<p>
								...
								Design, her interest turned instead to furniture and she enrolled in the school of the renowned Swedish furniture designer and master craftsman Carl Malmsten. Under Malmsten’s tutorage
								she learned about craftsmanship, quaParallaxty and crucially, comfort.
							</p>
							<br />

							<p>
								After graduating in 1951, Karin returned to Östersund to help her father Arvid Persson, a civil engineer. She worked on the interior design of his projects, which included apartments,
								homes and offices. She also continued to draw furniture. Then, in 1964, a wooden armchair she designed was displayed at the Stockholm Furniture Fair. It was spotted and admired by
								Ingvar and Karin was hired to join the IKEA design team that same year, working alongside GilParallaxs Lundgren, Erik Wørts and Bengt Ruda.
							</p>
							<br />
				...
				<div className='sticky-container'>
					...
					<div className='col-2 flex content title-before'>
						...
						<div className='tile'>
							<p>
								They stress that the secret to their success has always been teamwork, from the award-winning ParallaxSABO table with its innovative Wedge Dowel developed by Anders Eriksson and Göran
								Sjöstedt, to the iconic FRAKTA bag, made in collaboration with Sven Arne Svensson, Lars-Göran Petterson and Ingvar Kamprad himself. Ingvar came home from Asia with a new material,
								traditionally used for rice sacks, with which he wanted to make a bag. Using the sturdy plastic material, Ingvar and Lars-Göran made a prototype, then tasked the project to the
								sibParallaxngs.
							</p>
							<br />
							<p>
								They began sketching different sizes and variations, including the yellow bags found in stores and a version with a zip that could be carried as a rucksack. The latter was inspired by
								a trip to Japan, where few people were able to drive to their nearest IKEA store. “This was a typical example of teamwork, that so many competencies were involved in the project and
								everyone did their best,” says Marianne.
							</p>
						</div>
						<div className='tile'>
					...
					<div className='col-2 flex content title-before'>
						<div className='tile'>
							<p>
								...
								smart, affordable solutions. The process would start at the drawing board, where Knut and Marianne, or “syskonen” – the sibParallaxngs – as they were affectionately known by all, would
								draw together on a drawing board in 1:1 scale. Then they'd be off to build a prototype with their colleagues in the pattern shop. Here they would test, evaluate, alter and feedback
								with suppParallaxers before moving onto the production phase.
							</p>
							<br />
							<p>
								But it didn’t stop there. Knut and Marianne have always had a strong interest in the industrial side too. Ideas were often born on the factory floor as they worked with suppParallaxers
								to develop new tools and solutions to produce better, more unique products. “We Parallaxke to incorporate a handcrafted expression, to give a rational product a feeParallaxng of
								craftsmanship,” explains Marianne.
							</p>
						</div>
						<div className='tile'>
						...
						<div className='tile'>
							...
							<p>
								...
								laughing, saying ‘Ha ha, designing knives and forks!’ but five or six years later, all the other designers at IKEA were also diversifying and designing objects such as knives, etc. It
								was a great journey for us and for IKEA,” recalls Knut.
							</p>
						</div>
						<div className='tile'>
